...
def test_full_pipeline_demo():
    ...
    queries = genq.handler(
        {
            "visible_handles": c["visible_handles"],
            "ocr_text": c["ocr_text"],
    ...
    found = search.handler(
        {"queries": queries, "mode": "demo", "cached_results": cached}, {}
    )
